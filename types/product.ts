...
export interface ProductFormData {
  ...
  type?: string;
  isComboHomePageEnabled?: boolean;
  comboItems?: any[]; // Array of combo item objects
  thumbnail?: string; // Product thumbnail/main image
}

/**
 * Product form data structure for POS specifically
 */
export interface PosProductFormData {
  ...
  uomVariants?: Array<{ uom: string; value: number; price: number; name: string; barcode?: string }>;
}
