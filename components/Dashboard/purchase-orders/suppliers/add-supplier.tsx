            ...
            <div className="space-y-2 col-span-2">
              ...
              <ZipCodeInput
                ...
                onLocationSelect={(location) => {
                  setFormData((prev) => ({
                    ...prev,
                    shippingCity: location.city !== undefined ? location.city : prev.shippingCity,
                    shippingState: location.state !== undefined ? location.state : prev.shippingState,
                    shippingCountry: location.country !== undefined ? location.country : prev.shippingCountry,
                  }));
                }}
              />
            </div>
