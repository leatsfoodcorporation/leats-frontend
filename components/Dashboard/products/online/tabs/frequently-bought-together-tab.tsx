      ...
      if (response.data.success) {
        const allProductOptions: ProductOption[] = response.data.data
          .filter((product: {
            ...
            // Filter out combo products - only show regular products
            const isRegularProduct = !product.type || product.type === "regular";
            
            return isParentProduct && isNotCurrentProduct && isRegularProduct;
          })
          .map((product: {
            id: string;
