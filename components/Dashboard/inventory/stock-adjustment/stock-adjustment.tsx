                ...
                <TableRow key={adjustment.id}>
                  ...
                  <TableCell className="font-medium">
                    <span className={adjustment.adjustmentType === "increase" ? "text-green-600" : "text-red-600"}>
                      {adjustment.adjustmentType === "increase" ? "+" : "-"}
                      {adjustment.originalQuantity !== undefined && adjustment.originalQuantity !== null && adjustment.originalUom 
                        ? `${adjustment.originalQuantity}${adjustment.originalUom}`
                        : formatSmartUOMDisplay(adjustment.quantity, adjustment.uom || adjustment.originalUom || 'unit')}
                    </span>
                  </TableCell>
                  <TableCell className="whitespace-nowrap">
                    <div className="flex items-center gap-2">
                      <span className="text-muted-foreground">
                        {formatSmartUOMDisplay(adjustment.previousQuantity, adjustment.uom || adjustment.originalUom || 'unit')}
                      </span>
                      <span className="text-muted-foreground">→</span>
                      <span className="font-medium">
                        {formatSmartUOMDisplay(adjustment.newQuantity, adjustment.uom || adjustment.originalUom || 'unit')}
                      </span>
                    </div>
                  </TableCell>
                  <TableCell>
