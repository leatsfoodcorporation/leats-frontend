              ...
              ${order.items.map((item, index) => {
                return `
                  <tr style="border-bottom: 1px solid #e5e7eb; ${index % 2 === 1 ? 'background-color: #f8fafc;' : ''}">
                    ...
                    <td style="padding: 12px 8px; text-align: center; font-weight: 600; color: #1f2937;">${formatOrderItemQuantity(item.quantity, item.variantUom, item.variantUomValue)}</td>
