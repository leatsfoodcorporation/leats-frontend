...
export default function Footer01({ initialWebSettings, initialCompanySettings }: Footer01Props) {
  ...
  return (
    <footer className="bg-[#f1f1f1f1] text-gray-300 pt-8 sm:pt-12 pb-4 sm:pb-6">
      <div className="container mx-auto px-3 sm:px-4">
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 sm:gap-8 mb-6 sm:mb-8">
          ...
          <div className="col-span-2 sm:col-span-2 lg:col-span-2">
            ...
            <p className="text-xs sm:text-sm mb-3 sm:mb-4 text-black">
              ...
              <div className="flex gap-2 sm:gap-3">
                {companySettings?.socialMedia.facebook && (
                  <a
                    ...
                    className="w-8 h-8 sm:w-9 sm:h-9 hover:opacity-80 transition-opacity active:scale-95"
                  >
                    <Image
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-[#e63946] font-semibold mb-3 sm:mb-4 text-sm sm:text-base">
              Quick Links
            </h4>
            <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm">
              <li>
                <Link
                  href="/about"
                  className="hover:text-[#e63946] text-black transition-colors"
                >
                  About Us
                </Link>
              </li>
              ...
              {companySettings?.phone && (
                <li className="flex items-center gap-2">
                  ...
                  <a 
                    ...
                    className="hover:text-[#e63946] text-black transition-colors hover:underline"
                  >
                    {companySettings.phone}
                  </a>
                </li>
