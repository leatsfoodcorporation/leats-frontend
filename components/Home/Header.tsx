      ...
      <div className="bg-white shadow-sm">
        <div className="container mx-auto px-3 sm:px-4 py-2 sm:py-3">
          <div className="flex items-center justify-between gap-2 sm:gap-4 lg:gap-6">
            ...
            {/* Delivery Location - PC only (Mobile icon can be added if needed) */}
            <button 
              onClick={() => setIsModalOpen(true)}
              className="hidden lg:flex items-center gap-1.5 px-3 py-1.5 rounded-full hover:bg-gray-100 transition-colors border border-transparent hover:border-gray-200"
            >
              <IconMapPin size={20} className="text-[#e63946]" />
              <div className="text-left overflow-hidden max-w-[120px]">
                <p className="text-[10px] text-gray-500 font-medium uppercase truncate">Available in</p>
            ...
            {/* Mobile Delivery Location Icon - Shows only icon */}
            <button 
              onClick={() => setIsModalOpen(true)}
              className="lg:hidden text-gray-700 p-1 flex-shrink-0 relative"
              title="Select delivery location"
            >
              <IconMapPin size={22} className="text-[#e63946]" />
              {location && (
