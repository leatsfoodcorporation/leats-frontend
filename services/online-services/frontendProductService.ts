...
export interface ProductVariant {
  ...
  dropdownName?: string; // NEW: Short name for dropdown
  variantSKU: string;
...
export interface Product {
  ...
  type?: string; 
  thumbnail?: string; // ✅ FIX: Add thumbnail field for combo products
  comboItems?: any[]; // ✅ FIX: Add comboItems field for combo products
  isComboHomePageEnabled?: boolean; // ✅ FIX: Add combo homepage flag
